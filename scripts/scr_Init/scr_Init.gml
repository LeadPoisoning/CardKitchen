...
function InitProcCardInfo() { // obj_Game
	...
	ds_grid_set(global.procCardInfo,procCard.knife, 2, "A knife");
	i++;
...
function InitProcessGrid() { // obj_Game
	...
	ds_grid_set(global.processes, procCard.knife, foodCard.matoChopped, noone);
	ds_grid_set(global.processes, procCard.knife, foodCard.spinchChopped, noone);
	ds_grid_set(global.processes, procCard.knife, foodCard.tatoChopped, noone);
	
}

function InitRecipeGrid() { //obj_Player
	global.recipes = ds_grid_create(20, 20);
